...
class KafkaTestAdmin:
    ...
    def describe_topic(
        ...
        *,
        ...
        """Return current partition and replica metadata for an existing topic."""
    ...
    def list_topic_names(self) -> frozenset[str]:
        """List topic names without asking Kafka to auto-create a missing topic."""
        metadata = self._client.list_topics(timeout=self._timeout_seconds)
        return frozenset(metadata.topics)

    def delete_topic(self, name: str) -> None:
        """Delete a topic and wait until it disappears from broker metadata."""
